                ...
                <div class="px-5 pb-5" v-show="!isCompleted">
                    <div class="text-center">
                        <h1
                            ...
                            Database Deletion Result</h1>
 
                        <h2 class="p-4">Deletion Status...</h2>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async updateLatestPipelineStatusAndArtifacts() {
            ...
            const url = 'http://172.16.1.158:8002/api/v2/get_pipeline_status/';
        ...
        showSuccessPopup() {
            this.popupMessage = "Cluster Delete successful!";
        ...
        showFailedPopup() {
            console.log("faild");
            this.popupMessage = "Cluster Deletion failed. Please try again.";
