...
from userAuth_app.views import  UserAuthViewSet, LoginViewSet,AddRoleViewset,LDAPLoginView,IsConnectedAPIView
 
from .views import get_user_role
 
from rest_framework import routers

from .views import user_roles_api , get_ADgroup_users , list_ad_groups_with_members 
...
urlpatterns = [
    ...
    path('get-group-role/<str:group_name>/', views.get_group_role, name='get-group-role'),
