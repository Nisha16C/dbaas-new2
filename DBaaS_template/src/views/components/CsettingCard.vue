<template>
  <div class="card">
    ...
    <div>
    <h6>Selected Type: {{ selectedType }}</h6>
    <h6>Selected Provider: {{ selectedProvider }}</h6>
  </div>
      ...
      <ul class="list-group">
        ...
        >
          ...
          <div v-if="errorClusterNameExists" class="text-danger mt-2">{{ errorClusterNameExists }}</div>
            ...
            <select class="form-select" aria-label="Default select example" v-model="postgres_version">
