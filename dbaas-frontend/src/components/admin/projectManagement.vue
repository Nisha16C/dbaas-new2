  ...
  methods: {
    ...
    saveProject() {
      ...
      if (this.input1Error) {
        ...
        axios
          .post("http://172.16.1.69:8002/api/v2/project/", this.project)
          .then((response) => {
            this.fetchProject();
    ...
    fetchProject() {
      ...
      axios
        .get(`http://172.16.1.69:8002/api/v2/project/`)
        .then((response) => {
    ...
    renameProject() {
      ...
      axios
        .put(
          `http://172.16.1.69:8002/api/v2/project/${this.renamingProjectId}/rename/`,
          payload
        )
        .then((response) => {
