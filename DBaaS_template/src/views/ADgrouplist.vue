...
export default {
    ...
    methods: {
        ...
        fetchADGroups() {
            ...
            axios.get(`${this.apiUrl}/api/v1/list-gmember/`)
        ...
        //     console.log('print role' , savedRole)
        ...
        prepareAssignRoles(group) {
            this.selectedGroup = group;
            this.selectedGroupMembers = group.members; // Store group members for role assignment
            this.selectedRoles = ''; // Reset selected roles
            // this.$refs.myModal.show(); // Show the role assignment modal
            console.log(this.selectedGroupRoles)
        },
    ...
    try {
        ...
        const response = await axios.post(`${this.apiUrl}/api/v1/adgroup-role/`, {
            ...
            sAMAccountNames: this.selectedGroupMembers
        });
...
<!-- `${this.apiUrl}/api/v1/adgroup-role/` -->
