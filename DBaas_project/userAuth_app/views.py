...
class ADUserListView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            result_id = ldap_connection.search(settings.AUTH_LDAP_USER_SEARCH.base_dn, ldap.SCOPE_SUBTREE, settings.AUTH_LDAP_USER_SEARCH.filterstr)

            print("LDAP Connection:", ldap_connection)
            ...
            while True:
                ...
                if not result_data:
                    ...
                    if result_type == ldap.RES_SEARCH_ENTRY:
                        ...
                        ldap_users.append(result_data[0][1])
        ...
        for ldap_user in ldap_users:
            ...
            serialized_users.append({
                ...
                'username': ldap_user.get('sAMAccountName', [''])[0],

                'first_name': ldap_user.get('Administrator', [''])[0],

                'last_name': ldap_user.get('sn', [''])[0],
