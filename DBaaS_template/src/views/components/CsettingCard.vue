...
export default {
  ...
  methods: {
    ...
    checkClusterNameExists() {
        ...
        axios
        .get(`http://172.16.1.190:8002/api/v2/cluster/check_cluster_exists/?cluster_name=${this.cluster_name}&project_id=${this.project_id}`)
          .then((response) => {
    ...
    createCluster() {
      ...
      if (!this.postgres_version) {
        ...
        axios
        .get(`http://172.16.1.190:8002/api/v3/providers/by-username-and-name/${this.Username}/${this.selectedProvider}/`)
        .then((response)=>{
          ...
          axios
            .post(`http://172.16.1.190:8002/api/v2/cluster/`, fromData)
            .then(() => {
    ...
    fetchComputeOfferings() {
      axios
        .get('http://172.16.1.190:8002/api/v2/compute_offerings/')
        .then((response) => {
