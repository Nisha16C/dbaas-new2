<template>
  ...
  <adminLeftsidebar />
  <div v-show="!loading">
      <div class="cluster p-4 sm:ml-64 mt-24    flex">
        <div class=" p-4 w-full bg-gray-100 flex">
          <div class="text-black font-semibold text-4xl">Clusters </div>
        </div>
        <div class="ml-auto">
          ...
          <table class="min-w-full">
              ...
              <tr >
                ...
                >
                  <span
                    ...
                    >Postgres  {{ cluster.database_version }} </span
                  >
                </td>
            ...
            >
              <span
                ...
                >{{ formatTimeAgo(cluster.created_date) }} </span
              >
            </td>
            <td
              class="px-6 py-4 border-b border-gray-200 whitespace-nowrap"
            >
              <span
                class="inline-flex px-2 text-xs font-semibold leading-5
                 text-yellow-500 bg-yellow-100 rounded-full"
                >{{ formatTimeAgo(cluster.updated_date) }} </span
              >
            </td>
 ...
 import adminLeftsidebar  from '@/components/admin/adminLeftsidebar.vue'
  ...
  export default {
    ...
    methods: {
      ...
      fetchProjects() {
        axios.get(`http://127.0.0.1:8000/api/v2/project/`)
          .then(response => {
      ...
      fetchClusters() {
        axios.get(`http://127.0.0.1:8000/api/v2/cluster/`)
          .then(response => {
